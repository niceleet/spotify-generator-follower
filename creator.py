        ...
        while True:
            try:
                if self.settings['Use_Proxy'] == 'y':
                    ...
                    session = httpx.Client(headers={"User-Agent": "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/106.0.0.0 Safari/537.36"}, proxies={"http://": f"socks5://{proxy}","https://": f"socks5://{proxy}"})
                else:
